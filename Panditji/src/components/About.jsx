...
function About() {
  return (
    <div className='w-full h-[88vh] flex justify-between'>
        <div className="left w-[50vw] h-[88vh] ">
            <img src="https://vaikunth.co/front_assets/image/home-page-image/orange_chakker.png" alt="" className='h-[80vh] mt-6' />
        </div>
        <div className="right left w-[50vw] h-[88vh] text-start flex items-center text-2xl">
