...
function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const messageData = {
        ...formData,
        Date: new Date().toISOString(), // set date once here
      };
      ...
      <div className="w-1/2  bg-orange-100 flex flex-col items-center justify-center text-center">
        ...
        <div className="w-full p-6 flex justify-center ">
          <div className="w-3/4 h-300 rounded-lg overflow-hidden  ">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d14663.281683037998!2d77.470898!3d23.249621!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x397c4203e513c28f%3A0x15442925d721f3ba!2sBean%20Gate%20IT%20Solutions%20PVT.%20LTD.%20Mobile%20App%20Deveopment%20company%20in%20Bhopal%20%7C%20Website%2C%20Software%20companies%20in%20Bhopal!5e0!3m2!1sen!2sus!4v1738917827471!5m2!1sen!2sus"
        ...
        <div className=" space-x-4  w-full h-25 flex justify-center items-baseline gap-3 text-4xl">
          <a href="#" className="text-pink-500   hover:text-orange-900">
            <CiInstagram />
          </a>
          <a href="#" className="text-blue-600  hover:text-orange-900">
            {" "}
            <CiFacebook />
          </a>
          <a href="#" className="text-black  hover:text-orange-900">
            {" "}
            <FaXTwitter />
          </a>
          <a href="#" className="text-green-700  hover:text-orange-500 ">
            {" "}
            <BsWhatsapp />
          </a>
        </div>
